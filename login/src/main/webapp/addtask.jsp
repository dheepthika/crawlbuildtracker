...
String estimation=request.getParameter("Estimation");
		...
		PreparedStatement ps = con.prepareStatement("insert into taskdetails (id,team,requestedby,receivedon,projectname,task,scriptype,retailer,domain,subject,assignedto,iteration,startedon,ETA,ata,rta,comments,jiraid,estimation,status) values (?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)");
